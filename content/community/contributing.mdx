...
<Terminal commands={[
  { command: 'git clone https://github.com/YOUR_USERNAME/mediaproc.git' },
  { output: '✓ Cloned repository', isSuccess: true },
  { command: 'cd mediaproc' },
  { command: 'git remote add upstream https://github.com/mediaproc/mediaproc.git' },
  { output: '✓ Added upstream remote', isSuccess: true }
]} />
...
<Terminal commands={[
  ...
  { output: '✓ Installed pnpm globally', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'pnpm install' },
  { output: '✓ Installed dependencies', isSuccess: true },
  { command: 'pnpm build' },
  { output: '✓ Built all packages', isSuccess: true }
]} />
...
<Terminal commands={[
  ...
  { output: '✓ Created and switched to new branch', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'git checkout -b fix/issue-123' },
  { output: '✓ Created bugfix branch', isSuccess: true }
]} />
