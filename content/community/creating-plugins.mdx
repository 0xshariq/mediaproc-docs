...
<Terminal
  commands={[
    { command: "mkdir my-plugin" },
    { command: "cd my-plugin" },
    { command: "npm init -y" },
    { output: "✓ Created package.json", isSuccess: true },
  ]}
/>
...
<Terminal
  commands={[
    { command: "npm install commander chalk ora" },
    { output: "✓ Installed runtime dependencies", isSuccess: true },
  ]}
/>
...
<Terminal
  commands={[
    ...
    { output: "✓ Installed dev dependencies", isSuccess: true },
  ]}
/>
