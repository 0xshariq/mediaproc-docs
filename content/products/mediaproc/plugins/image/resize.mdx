...
<Terminal
  commands={[{ command: "mediaproc image resize <input> [options]" }]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Resized to 800×600 • Saved as photo-resized.jpg",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Resized to 800×600 • Saved as image-resized.png",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Resized to 1920×1080 • Saved as photo-resized.jpg",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Resized to 500×500 (cover mode) • Saved as photo-resized.jpg",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Resized to 200×200 (contain mode) • Saved as logo-resized.png",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    { command: "mediaproc image resize photo.jpg -w 500 -h 500 --fit cover" },
    {
      output: "✓ Cropped to 500×500 • Aspect ratio maintained",
      isSuccess: true,
    },
  ]}
/>
