...
<Terminal commands={[{ command: "mediaproc image tint <input> [options]" }]} />
...
| `--quality <quality>` | `-q`  | number  | -         | Output quality (1-100) (optional). Only applies to JPEG, WEBP, and AVIF. For PNG, quality is mapped to compression level (0-9, higher is more compressed). Ignored for other formats. |
