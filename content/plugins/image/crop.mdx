...
<Terminal commands={[
  { command: 'mediaproc image crop image.jpg -x 100 -y 100 -w 500 -h 500 -o region.jpg' },
  { output: '✓ Extracted region: 500x500 from position (100,100)', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image crop photo.png -x 800 -y 200 -w 400 -h 600 -o sidebar.png' },
  { output: '✓ Cropped: 400x600 from (800,200)', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image crop picture.jpg -x 250 -y 150 -w 800 -h 800 -o extracted.jpg' },
  { output: '✓ Region extracted: 800x800 from (250,150)', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image crop image.jpg -x 1000 -y 800 -w 920 -h 280 -o corner.jpg' },
...
<Terminal commands={[
  { command: 'mediaproc image crop photo.jpg -w 1920 -h 1080 -o widescreen.jpg' },
  { command: 'mediaproc image crop image.jpg -w 1600 -h 1200 -o standard.jpg' },
  { command: 'mediaproc image crop picture.jpg -w 1080 -h 1080 -o square_insta.jpg' },
...
<Terminal title="Instagram" commands={[
  { command: 'mediaproc image crop photo.jpg -w 1080 -h 1080 -o instagram.jpg' },
  { command: 'mediaproc image crop photo.jpg -w 1080 -h 1920 -o story.jpg' }
]} />

<Terminal title="Facebook & Twitter" commands={[
  { command: 'mediaproc image crop banner.jpg -w 820 -h 312 -o fb_cover.jpg' },
  { command: 'mediaproc image crop header.jpg -w 1500 -h 500 -o twitter_header.jpg' }
]} />
...
<Terminal commands={[
  { command: 'mediaproc image crop photo.jpg -w 150 -h 150 -o thumb_small.jpg' },
  { command: 'mediaproc image crop image.jpg -w 300 -h 300 -o thumb_medium.jpg' },
  { command: 'mediaproc image crop picture.jpg -w 600 -h 600 -o thumb_large.jpg' }
]} />
