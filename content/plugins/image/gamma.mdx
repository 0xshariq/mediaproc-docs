---
title: "gamma"
description: "Apply gamma correction to adjust image brightness and midtones without affecting pure black or white"
---
...
```bash
# Apply standard gamma correction (2.2 - sRGB default)
mediaproc image gamma photo.jpg

# Brighten image (lower gamma)
mediaproc image gamma photo.jpg -g 1.8

# Darken image (higher gamma)
mediaproc image gamma photo.jpg -g 2.8

# Apply gamma with output gamma
