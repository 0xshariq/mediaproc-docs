...
# Custom parameters
mediaproc image sharpen image.jpg -s 1.5 --flat 1.5 --jagged 2.5

# High quality output
mediaproc image sharpen photo.jpg -s 1.2 -q 95
```
...
- **Small images (<1MP)**: ~80-120ms
- **Medium images (5MP)**: ~200-300ms
- **Large images (>10MP)**: ~400-600ms
