...
<Terminal
  commands={[{ command: "mediaproc image recomb <input> [options]" }]}
/>
...
| `--quality <quality>` | `-q`  | number  | _(none)_                    | Output quality 1-100 (optional, only for JPEG, WebP, AVIF; for PNG, maps to compression level; ignored for others) |
