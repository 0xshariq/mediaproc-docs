...
<Terminal commands={[{ command: "mediaproc image sepia <input> [options]" }]} />

### Basic Usage

<Terminal
  commands={[
    { command: "mediaproc image sepia photo.jpg" },
    { output: "✓ Sepia effect applied (80% intensity)", isSuccess: true },
  ]}
/>

<InlineTerminal command="mediaproc image sepia image.png -i 100" />
<InlineTerminal command="mediaproc image sepia photo.jpg -i 50" />
<InlineTerminal command="mediaproc image sepia photo.jpg -o vintage.jpg" />
<InlineTerminal command="mediaproc image sepia image.jpg --dry-run" />
