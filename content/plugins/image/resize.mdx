---
title: Resize
description: Resize images to specified dimensions with advanced options and quality control
---
...
# Exact dimensions (crop to fit)
mediaproc image resize photo.jpg -w 500 -h 500 --fit cover

# Fit within dimensions (add padding)
