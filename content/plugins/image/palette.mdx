---
title: Palette
description: Extract dominant color palette from images for design inspiration
---
...
🎨 Dominant Color Palette:
  ...
  ██████ RGB(142, 168, 195) #8EA8C3

  Channel Analysis:
  Red   : ██ Avg: 142 (min: 12, max: 255)
  Green : ██ Avg: 168 (min: 15, max: 253)
  Blue  : ██ Avg: 195 (min: 18, max: 250)
...
- **Neutral**: Red ≈ Blue (balanced, grays, whites)
