...
| `--quality <quality>`   | `-q`  | number  | `90`              | Output quality (1-100). Only applies to JPEG, WEBP, and AVIF. For PNG, quality is mapped to compression level (0-9, higher is more compressed). Ignored for other formats. |
