...
<Terminal commands={[{ command: 'mediaproc image convert <input> -f <format> [options]' }]} />
...
<Callout type="info" title="Modern Format Benefits">
...
<Terminal commands={[
  { command: 'mediaproc image convert photo.jpg' },
  { output: '✓ Converted to WebP • 2.4 MB → 1.1 MB', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image convert image.png -f avif -o image.avif' },
  { output: '✓ Converted to AVIF • 892 KB → 312 KB', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image convert modern.webp -f jpg -o legacy.jpg' },
  { output: '✓ Converted to JPEG', isSuccess: true }
]} />

<InlineTerminal command="mediaproc image convert photo.jpg -f png -o photo.png" />

<InlineTerminal command="mediaproc image convert image.jpg -f tiff -o print_ready.tiff" />

<InlineTerminal command="mediaproc image convert image.png -f gif -o animation.gif" />
...
<Terminal commands={[
  { command: 'mediaproc image convert photo.jpg -f webp -q 95 -o high_quality.webp' },
  { output: '✓ Converted • Quality: 95 • Size: 2.8 MB', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image convert image.png -f jpg -q 90 -o standard.jpg' },
  { output: '✓ Converted • Quality: 90 • Size: 1.2 MB', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc image convert photo.jpg -f avif -q 80 -o medium.avif' },
  { output: '✓ Converted • Quality: 80 • Size: 420 KB', isSuccess: true }
]} />

<InlineTerminal command="mediaproc image convert image.jpg -f webp -q 70 -o compressed.webp" />

<InlineTerminal command="mediaproc image convert photo.png -f jpg -q 60 -o low_quality.jpg" />
