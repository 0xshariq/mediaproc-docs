...
<Terminal
  commands={[{ command: "mediaproc image compress <input> [options]" }]}
/>
...
<Callout type="warning" title="Quality vs File Size Trade-off">
...
| `-q, --quality` | number | -                          | Compression quality (1-100) (optional). Only applies to JPEG, WEBP, and AVIF. For PNG, quality is mapped to compression level (0-9, higher is more compressed). Ignored for other formats. |
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 2.45 MB → 1.12 MB (54% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 845 KB → 312 KB (63% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 3.2 MB → 890 KB (72% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 1.8 MB → 945 KB (48% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 5.8 MB → 425 KB (93% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
_Quality flag is mapped to compression level (0-9) for PNG. Higher quality means lower compression._
...
_Quality flag applies to AVIF and WebP. For other formats, the quality flag is ignored._
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 3.2 MB → 1.4 MB (56% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 4.5 MB → 680 KB (85% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 2.8 MB → 1.1 MB (61% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 3.5 MB → 890 KB (75% reduction)",
      isSuccess: true,
    },
  ]}
/>
...
<Terminal
  commands={[
    ...
    {
      output: "✓ Compressed: 2.5 MB → 420 KB (83% reduction)",
      isSuccess: true,
    },
  ]}
/>
