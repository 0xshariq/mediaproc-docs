...
```bash
# Default vignette (strength 50)
mediaproc image vignette photo.jpg

# Subtle vignette
mediaproc image vignette portrait.jpg -s 30

# Strong vignette
mediaproc image vignette landscape.png -s 80

# Custom output
mediaproc image vignette image.jpg -o artistic.jpg

# Batch processing
mediaproc image vignette "photos/*.jpg" -s 60
```
