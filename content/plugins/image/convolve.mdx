---
title: "convolve"
description: "Apply custom convolution kernels for advanced image filtering (sharpen, emboss, edge detection, blur)"
---
...
```bash
mediaproc image convolve <input> --kernel <preset> [options]
mediaproc image convolve <input> --custom <matrix> [options]
```
