---
title: "grayscale"
description: "Convert color images to grayscale (black and white) for artistic effects and print preparation"
---
...
mediaproc image greyscale <input> [options]
```
...
# With custom output
mediaproc image grayscale photo.jpg -o blackandwhite.jpg

# UK spelling works too
...
mediaproc image grayscale color-photo.jpg -o bw-photo.jpg

# Using UK spelling
mediaproc image greyscale portrait.jpg
```
...
mediaproc image grayscale photo.jpg -q 100 -o print-bw.jpg

# Balanced quality for web
mediaproc image grayscale photo.jpg -q 85 -o web-bw.jpg

# Lower quality for smaller file size
mediaproc image grayscale photo.jpg -q 75 -o small-bw.jpg
```
