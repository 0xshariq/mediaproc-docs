...
description: "Extract dominant colors from images for palette generation and color analysis"
---
...
```
Bucket size: 16
RGB(59, 89, 152) → Bucket(48, 80, 144)
RGB(61, 91, 155) → Bucket(48, 80, 144)
```
...
1. Resize image to 100×100 for faster processing
...
- Downscaling to 100×100 ensures fast analysis
...
1. **Image Size**: Analysis resizes to 100×100 internally (fast regardless of source size)
