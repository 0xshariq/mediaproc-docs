...
<Terminal
  commands={[{ command: "mediaproc image negate <input> [options]" }]}
/>
...
<Terminal
  commands={[
    { command: "mediaproc image negate photo.jpg" },
    { output: "✓ Created negative image", isSuccess: true },
  ]}
/>

<InlineTerminal command="mediaproc image negate image.png --alpha" />
<InlineTerminal command="mediaproc image negate pic.jpg -o inverted.jpg" />
<InlineTerminal command="mediaproc image negate photo.jpg --dry-run" />
