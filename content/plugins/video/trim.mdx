...
<Terminal commands={[
  ...
  { output: 'Output: video_trimmed.mp4 • Duration: 00:01:00 • 45.2 MB', isSuccess: true }
]} />
...
<Terminal commands={[
  { command: 'mediaproc video trim video.mp4 -s 00:01:00 -e 00:02:00 -o highlight.mp4' },
...
<Terminal commands={[
  { command: 'mediaproc video trim video.mp4 -s 00:01:00 -e 00:03:00 -o middle.mp4' },
