...
| `--scale`   |       | string  |         | Preset scale: `480p`, `720p`, `1080p`, `1440p`, `4k` |
| `--width`   | `-w`  | number  |         | Custom width in pixels                               |
| `--height`  | `-h`  | number  |         | Custom height in pixels                              |
| `--pad`     |       | boolean | false   | Add padding to maintain exact dimensions             |
...
| `4k`    | 3840x2160  | 16:9         | UHD, premium content           |
...
<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 --scale 720p' },
  { output: '✓ Resized to 1280x720', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 --scale 480p' },
  { output: '✓ Resized to 854x480 (mobile optimized)', isSuccess: true }
]} />

### Specify Output Location

<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 --scale 720p -o optimized.mp4' },
  { output: '✓ Saved to optimized.mp4', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 --scale 1080p -o output/' },
  { output: '✓ Saved to output/video_1920x1080.mp4', isSuccess: true }
]} />

### Custom Width

<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 -w 1280' },
  { output: '✓ Resized to 1280x720 (auto height)', isSuccess: true }
]} />

<InlineTerminal command="mediaproc video resize video.mp4 -w 800" />

<InlineTerminal command="mediaproc video resize video.mp4 -w 2560" />

### Custom Height

<InlineTerminal command="mediaproc video resize video.mp4 -h 720" />

<InlineTerminal command="mediaproc video resize vertical.mp4 -h 1920" />

### Custom Width and Height

<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 -w 1280 -h 720' },
  { output: '✓ Resized to 1280x720 (aspect ratio maintained)', isSuccess: true }
]} />

<InlineTerminal command="mediaproc video resize video.mp4 -w 1080 -h 1080" />

<InlineTerminal command="mediaproc video resize video.mp4 -w 1920 -h 800" />

### Padding Mode

<Terminal commands={[
  { command: 'mediaproc video resize video.mp4 -w 1080 -h 1080 --pad' },
  { output: '✓ Resized with black bars to maintain 1080x1080', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc video resize landscape.mp4 -w 1080 -h 1080 --pad' },
  { output: '✓ Instagram square with padding', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc video resize vertical.mp4 -w 1920 -h 1080 --pad' },
  { output: '✓ Letterbox effect applied', isSuccess: true }
]} />
...
<Terminal commands={[
  { command: 'mediaproc video resize 4k-video.mp4 --scale 1080p' },
  { output: '✓ 4K → 1080p • 3840x2160 → 1920x1080', isSuccess: true }
]} />

<InlineTerminal command="mediaproc video resize 4k-video.mp4 --scale 1440p" />

<InlineTerminal command="mediaproc video resize 4k-video.mp4 --scale 720p" />
