...
Output file: 4k-video_1920x1080.mp4
...
mediaproc video resize video.mp4 --scale 720p -o optimized.mp4

# Save to directory
mediaproc video resize video.mp4 --scale 1080p -o output/
```
...
mediaproc video resize video.mp4 -w 1280

# Downscale to 800px width
mediaproc video resize video.mp4 -w 800

# Ultra-wide width
mediaproc video resize video.mp4 -w 2560
```
...
mediaproc video resize video.mp4 -h 720

# Vertical video height
mediaproc video resize vertical.mp4 -h 1920
```

### Custom Width and Height

```bash
# Set both dimensions (maintains aspect ratio)
mediaproc video resize video.mp4 -w 1280 -h 720

# Square video
mediaproc video resize video.mp4 -w 1080 -h 1080

# Custom aspect ratio
mediaproc video resize video.mp4 -w 1920 -h 800
```

### Padding Mode

```bash
# Add black bars to maintain exact dimensions
mediaproc video resize video.mp4 -w 1080 -h 1080 --pad

# Instagram square with padding
mediaproc video resize landscape.mp4 -w 1080 -h 1080 --pad

# Letterbox effect
mediaproc video resize vertical.mp4 -w 1920 -h 1080 --pad
```

### Downscale 4K Content

```bash
# 4K to 1080p for standard displays
mediaproc video resize 4k-video.mp4 --scale 1080p

# 4K to 1440p for high-end displays
mediaproc video resize 4k-video.mp4 --scale 1440p

# 4K to 720p for streaming
mediaproc video resize 4k-video.mp4 --scale 720p
```
