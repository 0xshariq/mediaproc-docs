...
<Terminal commands={[{ command: 'mediaproc video merge <input1> <input2> [input3...] [options]' }]} />
...
<Terminal commands={[
  ...
  { output: 'Output: merged.mp4 • Duration: 00:05:45 • 180.3 MB', isSuccess: true }
]} />

<InlineTerminal command="mediaproc video merge part1.mp4 part2.mp4 part3.mp4" />

<Terminal commands={[
  { command: 'mediaproc video merge clip1.mp4 clip2.mp4 clip3.mp4 -o complete.mp4' },
...
<Terminal commands={[
  { command: 'mediaproc video merge video1.mp4 video2.mp4 -o output/combined.mp4' },
...
<Terminal commands={[
  { command: 'mediaproc video merge seg1.mp4 seg2.mp4 seg3.mp4 seg4.mp4 seg5.mp4 -o full.mp4' },
...
<Terminal commands={[
  { command: 'mediaproc video merge video.mp4 video.avi video.mkv -o combined.mp4' },
  { output: 'Input files:' },
...
<Terminal commands={[
  { command: 'mediaproc video merge video1.mp4 video2.mp4 video3.mp4 --dry-run' },
