...
<Terminal commands={[{ command: 'mediaproc video compress <input> [options]' }]} />
...
<Terminal commands={[
  ...
  { output: '✓ Compressed with CRF 28 • 600 MB → 180 MB (70% reduction)', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc video compress important-video.mp4 -q high' },
  { output: '✓ Compressed with CRF 18 • 450 MB → 315 MB (30% reduction)', isSuccess: true }
]} />

<Terminal commands={[
  { command: 'mediaproc video compress video.mp4 -q medium' },
  { output: '✓ Compressed with CRF 23 • 450 MB → 225 MB (50% reduction)', isSuccess: true }
]} />

### Custom CRF Value

<Terminal title="Ultra-high quality" commands={[
  { command: 'mediaproc video compress source.mp4 --crf 15' },
  { output: '✓ Compressed with CRF 15 (near-lossless)', isSuccess: true }
]} />

<Terminal title="Balanced quality" commands={[
  { command: 'mediaproc video compress video.mp4 --crf 20' },
  { output: '✓ Compressed with CRF 20', isSuccess: true }
]} />

<Terminal title="Higher compression" commands={[
...
<Terminal commands={[
  ...
  { output: '✓ Compressed with H.265 • 1.2 GB → 600 MB (50% smaller than H.264)', isSuccess: true }
]} />
...
<Terminal commands={[
  ...
  { output: '✓ Compressed with H.264 (maximum compatibility)', isSuccess: true }
]} />
