...
<Accordion type="single" collapsible className="w-full">
  <AccordionItem value="compress">
    ...
    <AccordionContent>
      <div className="space-y-2 pt-2">
        <p className="text-sm">CRF-based compression with quality presets (low, medium, high). Supports H.264, H.265, and VP9 codecs.</p>
  ...
  <AccordionItem value="trim">
    ...
    <AccordionContent>
      <div className="space-y-2 pt-2">
        <p className="text-sm">Extract specific time ranges with frame-perfect accuracy. Fast mode available for quick cuts without re-encoding.</p>
        <div className="text-sm text-muted-foreground">
  ...
  <AccordionItem value="resize">
    ...
    <AccordionContent>
      <div className="space-y-2 pt-2">
        <p className="text-sm">Scale to preset resolutions (480p-4K) or custom dimensions. Maintains aspect ratio with optional padding.</p>
        <div className="text-sm text-muted-foreground">
          <strong>Use Cases:</strong> Mobile optimization, 4K downscaling, social media sizing, adaptive streaming
        </div>
  ...
  <AccordionItem value="merge">
    ...
    <AccordionContent>
      <div className="space-y-2 pt-2">
        <p className="text-sm">Concatenate videos with smart format detection. Uses fast concat for identical formats or re-encodes when needed.</p>
        <div className="text-sm text-muted-foreground">
