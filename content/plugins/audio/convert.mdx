...
<Terminal
  commands={[
    ...
    { output: 'Converting: master.wav → master-converted.mp3', isSuccess: false },
    { output: 'Duration: 03:45.2 | Bitrate: 320k | Size: 8.9 MB', isSuccess: false },
...
<Terminal
  commands={[
    ...
    { output: 'Converting: album.flac → album-converted.m4a', isSuccess: false },
...
<Terminal
  commands={[
    ...
    { output: 'Original: 52.4 MB | Compressed: 28.1 MB (46% savings)', isSuccess: true }
  ]}
/>
